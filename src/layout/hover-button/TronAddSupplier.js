...
const TronAddSupplier = (props) => {
  return (
  <>
      <div className="btn-base--tron-radialAdjusted">
      ...
      <div className="btn-base--tron-hover1 btn-base--tron-hoverAdjusted HoverAdjust">
        <div
      ...
      <div className="btn-base--blackAddSupplier">
...
export default TronAddSupplier;
