...
import './BlackBigHeaderButtonWithGradient.css';

const BlackBigHeaderButtonWithGradient = (props) => {
    return (
        <>
            ...
            <div className="btn-base--tron-hoverBig">
              <div
                className="tron-hover-rotate1"
                style={{
            ...
            <div className="btn-base--blackBig">
              <div className="text-btn--navBig">{props.text}</div>
            </div>
        </>
        );
}

export default BlackBigHeaderButtonWithGradient
